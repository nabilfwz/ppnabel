    ...
    <section className="max-w-4xl mx-auto px-8 py-20 text-white">
      <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center">
        <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
          Pengalaman & Project History
        </span>
      </h2>

      <div className="relative border-l-2 border-cyan-500/30 pl-8 ml-4 space-y-12">
        {experiences.map((exp, idx) => (
          <div key={idx} className="relative group">
            {/* Timeline dot */}
            <div className="absolute -left-[41px] top-0 w-5 h-5 rounded-full bg-[#0a192f] border-2 border-cyan-400 group-hover:bg-cyan-400 group-hover:scale-125 transition-all duration-300" />

            <div className="bg-[#112240] p-6 rounded-2xl border border-cyan-500/20 group-hover:border-cyan-400/60 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-cyan-500/10">
